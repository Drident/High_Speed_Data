...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, STM_FPGA_SCK_Pin|STM_FPGA_MISO_Pin|STM_FPGA_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(STM_UI_MOSI_GPIO_Port, STM_UI_MOSI_Pin);

    HAL_GPIO_DeInit(STM_UI_SCK_GPIO_Port, STM_UI_SCK_Pin);
